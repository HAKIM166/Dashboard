 ...
 * FAQ Page
 * --------
 * Collapsible list of frequently asked questions to help users
 * quickly understand how to use and configure the analytics dashboard.
 */
